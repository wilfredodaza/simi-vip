        ...
        <div class="row">
          <div class="col s10 m6 l6 breadcrumbs-left">
            ...
            <ol class="breadcrumbs mb-0">
              ...
              <li class="breadcrumb-item active">Informe de Clientes</li>
            </ol>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-reveal">
          ...
          <table class="responsive-table">
            ...
            <tr>
              <th>Mes</th>
              <th v-for="(item, index) of info" style="text-align: center;">{{ month(index + 1)  }} - {{ year }}</th>
            </tr>
            </thead>
            <tbody>
...
export default {
  ...
  methods: {
    information() {
      Axios.get(`${this.url}/api/v1/graphic/sales_of_customer`).then((response) => {
