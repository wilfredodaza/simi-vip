                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col s10 m6 l6 breadcrumbs-left">
                            ...
                            <span>
                                Cartera
                                <a class=" btn-small purple step-1 help" style="padding-right: 10px; padding-left: 10px;">Ayuda</a>
                            </span>
                            </h5>
                                        ...
                                        <table class="table-responsive">
                                            ...
                                            <?php foreach ($wallets as $item):?>
                                                <tr>
                                                    ...
                                                    <td class="center">$ <?= number_format($item->payable_amount - $item->withholdings, '2', ',', '.') ?></td>
                                                    <td class="center">$ <?= number_format($item->payable_amount - $item->withholdings - $item->balance - ($item->credit_note - $item->credit_note_withholdings), '2', ',', '.') ?></td>
                                                    <td class="center">$ <?= number_format( $item->balance , '2', ',', '.') ?></td>
                                                    <td class="center">
                                                        <?php
                                                    ...
                                                    <td class="center">
                                                        <div class="btn-group center" role="group">
                                                            <a href="#update-file" class="btn btn-small sm green lighten-1 modal-trigger edit tooltipped" data-id="<?= $item->id ?>" data-toggle="modal" data-position="top" data-tooltip="Registrar pago" data-customer="<?= $item->name ?>">
                                                                <i class="material-icons">attach_money</i>
                                                            </a>
                                                            <a href="<?= base_url() . '/wallet/show/' . $item->id ?>" class="btn btn-small yellow darken-2 tooltipped" data-position="top" data-tooltip="Detalle del Pago">
                                            ...
                                            <?php if (count($wallets) == 0): ?>
                                                <tr>
                                                    <td colspan="7">
                                                        <p class="center red-text py-2" >No hay ningún elemento en el módulo cartera.</p>
                                                    </td>
                                                </tr>
                                            <?php endif ?>
                                            <tr>
                                                ...
                                                <td class="center">$ <?= number_format($collected, '2', ',', '.') ?></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                        <?= $pager->links() ?>
            ...
            <div id="filter" class="modal" role="dialog" style="height:auto; width: 600px">
                <div class="modal-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6 input-field">
                            <input type="date" id="start_date_collect" disabled name="start_date_collect">
                            <label for="start_date_collect">Fecha de inicio recaudado</label>
                        </div>
                        <div class="col s12 m6 input-field">
                            <input id="end_date_collect" disabled type="date" name="end_date_collect">
                            <label for="end_date_collect">Fecha fin recaudado</label>
                        </div>
                        <div class="col s12 m6 input-field">
                            <label for="customer" class="active">Cliente</label>
