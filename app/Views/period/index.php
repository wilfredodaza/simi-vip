                ...
                <div class="row">
                    ...
                    <div class="col s10 m6 l6 breadcrumbs-left">
                        <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down ">
                            <span>
                                Periodos de Nomina Electrónica
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="center">
                                                        <div class="btn-group">
                                                            <a href="<?= base_url('periods/'. $item->id) ?>" class="btn btn-small yellow darken-2 tooltipped" data-tooltip="Ver Nomina"><i class="material-icons">remove_red_eye</i> </a>
                                                            <?php if($item->emiter == 0 && session('user')->role_id != 10): ?>
                                                                <form action="<?= base_url('periods/delete/'. $item->id) ?>" method="post">
