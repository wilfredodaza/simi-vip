                    ...
                    <div class="card">
                        <div class="card-content" style="margin-bottom: 100px;">
                            <?php if(count($searchShow) != 0): ?>
                                <a href="<?= base_url('periods/'.$id) ?>" class="btn right btn-light-red btn-small ml-1"   style="padding-left: 10px;padding-right: 10px; ">
                                            ...
                                            <td class="center">
                                                <div class="btn-group">
                                                    <?php  if($item->invoice_status_id != '12' && $item->invoice_status_id != '13'  && $item->invoice_status_id != '15' && $item->invoice_status_id != '16'): ?>
                                                        <a href="<?= base_url('payrolls/download/'.$item->invoice_id) ?>" class="btn btn-small pink darken-1 tooltipped" data-tooltip="Descargar PDF de la Nomina">
                                                            <i class="material-icons">insert_drive_file</i>
                                                        </a>
                                                    <?php  endif; ?>
                                                    <?php  if($item->invoice_status_id == '13'): ?>
                                                        <a href="<?= base_url('payrolls/download_previsualization/'.$item->invoice_id) ?>" class="btn btn-small pink darken-1 tooltipped" data-tooltip="Descargar PDF de la Nomina"> 
                                                            <i class="material-icons">insert_drive_file</i>
                                                        </a>
                                                    <?php  endif; ?>
                                                    <?php if(session('user')->role_id != 10): ?>
                                                    <?php  if($item->invoice_status_id != '14' && $item->invoice_status_id != '16'): ?>
                                                        <a href="<?= base_url('payroll/edit/'.$item->invoice_id) ?>" class="btn btn-small indigo tooltipped" data-tooltip="Editar Nomina">
                                                    ...
                                                    <?php  if($item->invoice_status_id != '13' && $item->invoice_status_id != '12' && $item->invoice_status_id != '15' && $item->invoice_status_id != '16'): ?>
                                                        <a href="<?= base_url('payrolls/xml/'.$item->invoice_id) ?>"  class="btn btn-small tooltipped" data-tooltip="Descargar XML de la  Nomina">
