                                ...
                                <div class="row">
                                    ...
                                    <div class="col m12 s12 ">
                                        <div class="float-left">
                                            <span class="badge new green lighten-1 m-1" data-badge-caption="Finalizado"></span>
                                            <span class="badge new light-green m-1" data-badge-caption="Pruebas y Credenciales"></span>
                                            <span class="badge new light-blue m-1" data-badge-caption="Validación"></span>
                                            <span class="badge new yellow darken-2 m-1" data-badge-caption="Prevalidación"></span>
                                            <span class="badge new yellow darken-4 m-1" data-badge-caption="En espera"></span>
                                            <span class="badge new pink darken-1 m-1" data-badge-caption="Solicitada"></span>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                    ...
                                    <table>
                                        ...
                                        <?php foreach ($solicitudes as $item): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?= ($item['process'] == 'enuevo')?'Empresa nueva':'Renovación' ?></td>
                                                <td class="text-center state" width="150px">
                                                    <?php switch ($item['estado']) {
                                                        case 'Solicitada':
                                                            echo '<span class="badge new pink darken-1 "  data-badge-caption="' . $item['estado'] . '" ></span>';
                                                            break;
                                                        case 'En espera':
                                                            echo '<span style="margin-top:5px;" class="badge new yellow darken-4"  data-badge-caption="' . $item['estado'] . '"></span>';
                                                            break;
                                                        case 'Validacion':
                                                            echo '<span style="margin-top:5px;" class="badge new light-blue"  data-badge-caption="Validación"></span>';
                                                            break;
                                                        case 'Pruebas y credenciales':
                                                            echo '<span  class="badge new light-green"  data-badge-caption="' . $item['estado'] . '"></span>';
                                                            break;
                                                        case 'Finalizado':
                                                            echo '<span class="badge new green lighten-1"   data-badge-caption="' . $item['estado'] . '"></span>';
                                                            break;
                                                        default:
                                                            echo '<span style="margin-top:5px;" class="badge new yellow darken-2"  data-badge-caption="Prevalidación"></span>';
                                                            break;
                                                    }
                                                    ?>
                                                </td>
                                                ...
                                                <td width="220px" style="display: flex; justify-content: center;">
                                                    <a href="/solicitudes/info/<?= $item['idsolicitud'] ?>"
                                                    ...
                                                    <a href="<?= base_url() ?>/solicitud/informacion/<?= $item['idsolicitud'] ?>"
                                                       class="btn btn-small  light-blue remove_red_eye tooltipped" target="_blank"
                                                       style="padding:0px 10px;" data-position="center"
