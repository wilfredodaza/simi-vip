<div class="card-content">
    <div class="row">
        <div class="input-field col l6 m6 s12">
            <input id="titulo" name="titulo" type="number" value="16" class="validate"
                   required>
            <label class="active" for="titulo">Número de fila del encabezado hoja 1</label>
        </div>
        <div class="input-field col l6 m6 s12">
            <input id="titulo2" name="titulo2" type="number" value="7" class="validate"
                   required>
            <label class="active" for="titulo2">Número de fila del encabezado hoja 2</label>
        </div>
        <div class="input-field col l4 m4 s12 hide">
            <input id="titulo3" name="titulo3" type="number" value="0" class="validate"
                   required>
