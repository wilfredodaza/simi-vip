                        ...
                        <div class="card-alert card red">
                            <div class="card-content white-text">
                                ...
                                <p><strong>Error</strong>, no se pudo validar el archivo ya que se
                                    encontraron <?= $cantidaderror ?> errores.<br><a href="#modal1" class=" btn  btn-flat white-text modal-trigger">Ver Errores ..</a><br>
                                    Los archivos han sido eliminados, se debe realizar el cargue con las correcciones correspondientes.
                                </p>
                            </div>
                            <button type="button" class="close white-text" data-dismiss="alert"
                                    aria-label="Close">
                    ...
                    <div class="card">
                        <div class="row">
                            ...
                            <div id="load" class="col s12">
                                <form action="<?= base_url() ?>/import/load" method="post"
                                      enctype="multipart/form-data">
                                    <?php
                                    if (company()->identification_number == 800174904) {
                                        echo view('import/Etipress_import');
                                    } elseif (company()->identification_number == 900306514) {
                                        echo view('import/Zona_Seguridad_import');
                                    } elseif (company()->identification_number == 830015914){
                                        echo view('import/Polyuprotec_import');
                                    } elseif (company()->identification_number == 800210669){
                                        echo view('import/Transgalaxia_import');
                                    }elseif (company()->identification_number == 900739531){
                                        echo view('import/Servimos_import');
                                    }elseif (company()->identification_number == 860000824){
                                        echo view('import/Niver_import');
                                    }elseif (company()->identification_number == 830065471){
                                        echo view('import/Grancolservig_import');
                                    }elseif (company()->identification_number == 800188477){
                                        echo view('import/Grancolombiana_import');
                                    }elseif (company()->identification_number == 830090360){
                                        echo view('import/San_marcos_import');
                                    }elseif (company()->identification_number == 901131030){
                                        echo view('import/Master_energy_import');
                                    }elseif (company()->identification_number == 900515864){
                                        echo view('import/Suarez_leon_import');
                                    }elseif (company()->identification_number == 860054862){
                                        echo view('import/Ingemol_import');
                                    }elseif(company()->identification_number == 900082400){
                                        echo view('import/Punto_empresarial_import');
                                    }elseif(company()->identification_number == 800198348){
                                        echo view('import/Ventas_institucionales');
                                    }elseif(company()->identification_number == 830010090){
                                        echo view('import/Am_import');
                                    }elseif(company()->identification_number == 900061320){
                                        echo view('import/Serya_import');
                                    }elseif(company()->identification_number == 900803958){
                                        echo view('import/Altara_import');
                                    }elseif(company()->identification_number == 830056362){
                                        echo view('import/Andina_rodillos_import');
                                    }elseif(company()->identification_number == 900127454){
                                        echo view('import/Tampa_import');
                                    }if (company()->identification_number == 901084243) {
                                        echo view('import/Market_import');
                                    }elseif(company()->identification_number == 900744829){
                                        echo view('import/Sinergia_import');
                                    }elseif(company()->identification_number == 900804617){
                                        echo view('import/Giron_import');
                                    }elseif(company()->identification_number == 901347237){
                                        echo view('import/Yaraguies_import');
                                    }
                                    ?>
                                </form>
                            </div>
                                ...
                                <form id="form"
                                    ...
                                    <div class="card-content">
                                        <div class="input-field col l12 m12 s12">
                                            ...
                                            <select id="monthValidation" class="select2 browser-default" name="month" required>
                                                <option value="" disabled="" selected="">Seleccione una opción</option>
                                                <?php foreach ($periods_active as $active):?>
                                                    <option value="<?= $active['month'] ?>" >
                                                        <?= ($active['document'] == 9)?$active['name_month'].' - Nómina Individual - '.$active['year']:$active['name_month'].' - Nómina de Ajuste - '.$active['year'] ?>
                                                    </option>
                                                <?php endforeach;?>
                                            </select>
                                        </div>
                                        <!--<div class="input-field col l6 m6 s12 " style="display: none !important;">
                                            <h6>
                                                Periodo de liquidación
                                            </h6>
                                            <select id="period_validation" class="select2 browser-default" name="period"
                                                    required>
                                            </select>
                                        </div>-->
...
<div class="container-sprint-validando" style="display:none;">
    ...
    <span style="width: 100%; text-align: center; color: white;  display: block; ">Validando Información, esto podría demorar unos minutos de acuerdo a la cantidad de filas</span>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('#btncargue').click(function () {
            if(month != false && period != false && file != false && year != false && document != false){
