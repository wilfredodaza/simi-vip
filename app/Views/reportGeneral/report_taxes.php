                        ...
                        <div class="card-content">
                                ...
                                <div class="row">
                                    <div class="col s12 ">
                                        <ul class="collapsible collapsible-filter" style="box-shadow: none;">
                                            <li class="active">
                                                <div class="collapsible-header"><i class="material-icons">search</i>Filtrar Reporte de IVA</div>
                            ...
                            <div class="row">
                                <div class="col s12">
                                    ...
                                    <span class="card-title" s style="margin-top: 20px;margin-bottom: 0px;">
                                        <a href="<?= base_url() . '/report_taxes/excel' ?>"
                                         ...
                                         Reporte de IVA generado en facturas de venta<br>
                                    </span>
                                    <small style="margin-bottom: 10px; display: block;">En este Reporte se detalla el IVA cobrado por producto y factura.Va a nivel de producto y factura.</small>
                                    ...
                                    <div class="table-response" style="overflow-x:auto;">
                                        <table class="table">
                                            ...
                                            $taxes = taxes($item->id, $item->type_documents_id, true);
...
<script type="text/javascript">
    const vue = new Vue({
        ...
        mounted() {
            ...
            this.seller();
            this.user();
            if (localStorage.getItem('filters_iva')) {
                const data              = JSON.parse(localStorage.getItem('filters_iva'));
        ...
        methods: {
            send() {
                ...
                localStorage.setItem('filters_iva', JSON.stringify(data));
                axios.post(`${localStorage.getItem('url')}/report_taxes`, data).then((response) => {
                    location.reload();
                });
            },
            customer() {
            ...
            reset() {
                if (localStorage.getItem('filters_iva')) {
                    localStorage.removeItem('filters_iva');
                    const url = localStorage.getItem('url');
                    location.href = url + '/report_taxes/reset'
                }
