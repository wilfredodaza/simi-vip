                ...
                <div class="row">
                    ...
                    <div class="col s12 m12 l12 breadcrumbs-left">
                        ...
                        <ol class="breadcrumbs mb-0">
                            ...
                            <li class="breadcrumb-item active"><a href="<?= base_url() ?>/table/customers">clientes</a></li>
                                    ...
                                    <ul class="stepper horizontal" style="min-height: 600px;">
                                        <li class="step">
                                            ...
                                            <div class="step-content" style="height: auto;">
                                                <form action="<?= base_url() . route_to('customer.updatePayment', $customer->id) ?>"
                                                      method="post">
                                                    <div class="row">
                                                        <div class="col s12 m12 l12">
                                                            <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col m4 s12 input-field">
                                                                    ...
                                                                    <label class="active" for="quota">Cupo</label>
                                                                </div>
                                                                <div class="col m4 s12 input-field">
                                                                    <input type="text" disabled name="balance"
                                                                           id="balance" value="<?= ($customer->quota ?? 0) - $debt?>">
                                                                    <label class="active" for="balance">Saldo</label>
                                                                </div>
                                                                <div class="col m4 s12 input-field">
                                                                    <label for="payment_policies" class="active">Politicas
                                                                        de pago</label>
                                                                    <select class="browser-default"
                                                                            id="payment_policies"
                                                                            name="payment_policies">
                                                                        <option value="">Seleccione ...</option>
                                                                        <?php foreach ($paymentPolicies as $paymentPolicy) : ?>
                                                                            <option value="<?= $paymentPolicy->id ?>" <?= ($customer->payment_policies == $paymentPolicy->id) ? 'selected' : '' ?>>
                                                                                <?= $paymentPolicy->days ?> Dias
                                                                            </option>
                                                                        <?php endforeach; ?>
                                                                    </select>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col m4 s12 input-field">
                                                                    ...
                                                                    <select class="browser-default select2"
                                                                            id="type_client_status"
                                                                            name="type_client_status">
                                                                        <option value="">Seleccione ...</option>
                                                                        <option <?= ($customer->type_client_status == '01')?'selected':'' ?> value="01">01</option>
                                                                        <option <?= ($customer->type_client_status == '02')?'selected':'' ?> value="02">02</option>
                                                                        <option <?= ($customer->type_client_status == '03')?'selected':'' ?> value="03">03</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col m4 s12 input-field">
                                                                    <label for="frequency" class="active">Tipo de cliente</label>
                                                                    <select class="select2 browser-default"
                                                                            id="frequency"
                                                                            name="frequency">
                                                                        <option value="">Seleccione una frecuencia ...</option>
                                                                        <option <?= ($customer->frequency == 'Diario')?'selected':'' ?> value="Diario">Diario</option>
                                                                        <option <?= ($customer->frequency == 'Semanal')?'selected':'' ?> value="Semanal">Semanal</option>
                                                                        <option <?= ($customer->frequency == 'Quincenal')?'selected':'' ?> value="Quincenal">Quincenal</option>
                                                                        <option <?= ($customer->frequency == 'Mensual')?'selected':'' ?> value="Mensual">Mensual</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col s12 m12 l12">
                                                                ...
                                                                <?php if (isset($_GET['start_date']) || isset($_GET['end_date']) ):
                                                                    if($_GET['option'] == 'c'):
                                                                    ?>
                                                                    <a href="<?= base_url('/customers/profile/'.$customer->id) ?>"
...
<script>
    $(document).ready(function () {
        $('#table_compras').DataTable({
            "ajax": {
                "url": `<?= base_url() ?>/customers/shopping/<?= $customer->id ?>`,
        ...
        $('#table_product').DataTable({
            "ajax": {
                "url": `<?= base_url() ?>/customers/products/<?= $customer->id ?>`,
                "data": {'start_date': '<?= $start_date ?>', 'end_date': '<?= $end_date ?>','option': '<?= $option ?>'},
                "dataSrc": ''
            },
            "order": [[0, 'desc']],
