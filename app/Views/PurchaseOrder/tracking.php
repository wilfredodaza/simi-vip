...
<?= $this->section('title') ?> Seguimiento Ordenes <?= $this->endSection() ?>
...
<div id="app">
    <div id="main">
                    ...
                    <div class="row">
                        ...
                        <div class="col s10 m6 l6 breadcrumbs-left">
                            ...
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item active"><a href="<?=  base_url().route_to('purchaseOrder-index') ?>">Ordenes de compra</a></li>
                                <li class="breadcrumb-item active"><a href="<?=  base_url().route_to('purchaseOrder-tracking', $id) ?>">Seguimientos</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="section">
                        <div class="card">
                            <div class="card-content">
                                <a href="<?=  base_url().route_to('purchaseOrder-index') ?>" class="btn btn-light-indigo  right ml-1" style="padding-left:5px; padding-right:10px;">
        ...
        <form action="<?= base_url('/tracking/create/'.$id.'/purchaseOrder') ?>" method="post" id="form">
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $('.quotation_edit').click(function () {
                        ...
                        $('#formEdit').attr('action', `${url}/tracking/update/${quotationId}/purchaseOrder/${id}`)
