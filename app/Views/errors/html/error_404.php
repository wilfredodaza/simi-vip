...
<head>
    ...
    <link rel="apple-touch-icon" href="<?= base_url('assets/img/42x42.png'); ?>">
            ...
            <div class="section section-404 p-0 m-0 height-100vh">
                <div class="row">
                    ...
                    <div class="col s12 center-align white">
                        <img src="<?= base_url() ?>/assets/img/error-2.png" class="bg-image-404" alt="">
                        <h1 class="error-code m-0">404</h1>
                        <h6 class="mb-2">BAD REQUEST</h6>
                        <a href="<?= base_url('/home'); ?>" class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="dashboard-ecommerce.html">Back
                            TO Home</a>
                    </div>
                </div>
            </div>
