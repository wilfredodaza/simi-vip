                ...
                <div class="section">
                    <div class="card">
                        <div class="card-content">
                            ...
                            <form action="<?= base_url() ?>/import_health" method="post" enctype="multipart/form-data">
                                <div class="row mt-2">
                                    ...
                                    <div class="col s12 m12">
                                        ...
                                        <button class="btn right btn-small ml-2" type="button" id="upload">Enviar Facturas  a DIAN</button>
    ...
    $(document).ready(function(){
        ...
        $("#tipoD").change(function(){
            ...
            if(documento == 5){
                ...
                $('#plantilla').attr('href',url+'/upload/Facturas.xlsx');
                $('#plantilla').attr('download','Facturas.xlsx');
            }
        });


        $('#upload').click(function() {
            axios.get(localStorage.getItem('url')+'/api/v1/invoices/all',  { headers :{
                ...
                .then(function (response) {
                    ...
                    var interval = setInterval(function(){
                        ...
                        axios.get(localStorage.getItem('url')+'/document_support/send/'+invoice[l].invoice_id + '/51', invoice[l], { headers :{
                                'Content-Type': 'application/json',
                                'Accept': 'application/json',
                                "Access-Control-Allow-Origin": "*"
                            }}).then(function (response) {
