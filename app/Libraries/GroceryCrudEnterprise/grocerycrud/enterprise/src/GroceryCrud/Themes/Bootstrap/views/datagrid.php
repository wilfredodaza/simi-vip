<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.8.1.0659b25.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.8.1.0659b25' . $minify_or_not . '.js');
