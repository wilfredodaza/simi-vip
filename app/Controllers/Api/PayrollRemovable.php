...
class PayrollRemovable extends ResourceController
{
    ...
    {
        $invoice = $this->model
            ->select(['invoices.*',  'payrolls.*','payrolls.id as payroll_id', 'invoices.id as invoices_id', 'payrolls.sub_period_id'])
    ...
    public function update($id = null)
    {
        ...
        $payroll->update(['invoice_id' => $id],[
            'settlement_start_date' => $json->period->settlement_start_date,
            'settlement_end_date'   => $json->period->settlement_end_date,
            'worked_time'           => $json->period->worked_time
        ]);
