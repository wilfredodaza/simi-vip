...
class Payroll_Z_seguridad extends BaseController
{
    ...
    public function init_zona_de_seguridad($nit, $month_payroll)
    {
        ...
        //$this->functions_payroll->save_acrueds_new($info);
        //$this->functions_payroll->save_deduction_new($info);
