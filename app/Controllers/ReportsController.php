...
class ReportsController extends BaseController
{
    ...
    public function customerAges()
    {
        ...
        $data = [
            ...
            'customers' => $this->tableCustomers->where(['companies_id' =>  Auth::querys()->companies_id])->whereIn('type_customer_id', [1,2])->asObject()->get()->getResult(),
    ...
    public function incomeAndExpenses()
    {
        $this->activeUser();
        $option = '';
        $customers = $this->tableCustomers->where(['companies_id' => Auth::querys()->companies_id])->get()->getResult();
        $companies = $this->tableCompanies->whereIn('id', $this->controllerHeadquarters->idsCompaniesHeadquarters())->get()->getResult();
    ...
    public function providersAges()
    {
        ...
        $data = [
            ...
            'invoices60' => ['quantity' => count($invoicesMax60), 'total' => $this->totalCa($invoicesMax60)],
            'invoices90' => ['quantity' => count($invoicesMax90), 'total' => $this->totalCa($invoicesMax90)],
            'customers' => $this->tableCustomers->where(['companies_id' =>  Auth::querys()->companies_id])->whereIn('type_customer_id', [2])->asObject()->get()->getResult(),
